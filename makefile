...
CFLAGS = -Wall $(LIB) -c -fno-builtin -W -Wstrict-prototypes \
         -Wmissing-prototypes -fno-stack-protector -z execstack
...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/print.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
      $(BUILD_DIR)/kernel.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/debug.o \
	  ...
	  $(BUILD_DIR)/ide.o $(BUILD_DIR)/stdio-kernel.o $(BUILD_DIR)/fs.o
...
$(BUILD_DIR)/memory.o : kernel/memory.c kernel/memory.h lib/stdint.h \
				lib/kernel/bitmap.h kernel/global.h kernel/debug.h \
...
hd:
	dd if=$(BUILD_DIR)/kernel.bin \
           of=/home/ba/bochs/hd60M.img \
           bs=512 count=200 seek=9 conv=notrunc

hdgdb:
	dd if=$(BUILD_DIR)/kernel.bin of=/home/ba/bochsgdb/hd60M.img bs=512 count=200 seek=9 conv=notrunc

clean:
	@cd $(BUILD_DIR) && rm -f ./*.bin ./*.o
